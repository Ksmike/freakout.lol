...
export const appLabels: AppLabels["app"] = {
  ...
  settings: {
    ...
    billingPendingDescription:
      "Stripe returned you to Settings, but the subscription is still syncing. Refresh shortly if the plan does not update.",
    billingCanceledHeading: "Checkout canceled",
    billingCanceledDescription:
      "No subscription changes were made. You can restart checkout when you are ready.",
    billingSyncErrorHeading: "Billing sync needs attention",
    billingSyncErrorDescription:
      "Stripe returned from checkout, but this app could not verify the subscription for the active firm.",
  },
  draft: {
  ...
  admin: {
    sidebarCta: "Admin",
    navigationHeading: "Admin",
    usersNav: "Users",
    graphsNav: "Graph Studio",
    usersHeading: "User Management",
    usersDescription: "Manage platform admin roles and inspect registered users.",
    ...
    promoteCta: "Promote",
    demoteCta: "Demote",
    userDetailHeading: "User",
    userDetailDescription: "Inspect account metadata and platform activity.",
    backToUsersCta: "Users",
    userIdLabel: "User ID",
    emailLabel: "Email",
    nameLabel: "Name",
    ...
    firmMembershipsCountLabel: "Firm memberships",
