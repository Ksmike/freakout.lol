...
export type AppLabels = {
  ...
  app: {
    ...
    settings: {
      ...
      billingCanceledHeading: string;
      billingCanceledDescription: string;
      billingSyncErrorHeading: string;
      billingSyncErrorDescription: string;
    };
    draft: {
      heading: string;
      description: string;
    ...
    admin: {
      ...
      promoteCta: string;
      demoteCta: string;
      userDetailHeading: string;
      userDetailDescription: string;
      backToUsersCta: string;
      userIdLabel: string;
      emailLabel: string;
      nameLabel: string;
